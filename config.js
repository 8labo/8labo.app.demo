window.EIGHTLABO_CONFIG = {
  ...
  serviceUrls: { ACADEMY: 'https://8labo.github.io/8labo-academy.app.demo2/', BIZFIT: 'https://8labo.github.io/bizfit-club.app.demo2/' },
...
(function(){
 ...
 const loadStaffPermissionUI=()=>{if((location.pathname.split('/').pop()||'')!=='staff.html')return;const s=document.createElement('script');s.src='staff-permission-ui.js?v=1';s.defer=true;document.head.appendChild(s)};
 const loadShiftResponseUI=()=>{if((location.pathname.split('/').pop()||'')!=='shift-v2.html')return;const s=document.createElement('script');s.src='shift-response-ui-v2.js?v=1';document.body.appendChild(s)};
 const init=()=>{wireServiceLinks();addStaffAdminEntry();loadWebsitePhotoEditor();loadWebsiteVoiceUI();loadOfficeAuthUI();loadPortalContextUI();loadStaffPermissionUI();loadShiftResponseUI()};if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',init);else init();
})();