...
(function () {
  ...
  const loadWebsitePhotoEditor = () => {
    ...
    ['photo-editor-v2.js?v=3','photo-brightness.js?v=1'].forEach(src=>{const script=document.createElement('script');script.src=src;script.defer=true;document.head.appendChild(script);});
  };
